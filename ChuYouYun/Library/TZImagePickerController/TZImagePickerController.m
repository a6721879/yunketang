...
@property(nonatomic,assign)BOOL singleImg;//单张图片
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount delegate:(id<TZImagePickerControllerDelegate>)delegate singleChoose:(BOOL)sChoose{
...
- (void)pushToPhotoPickerVc {
    ...
    if (_pushToPhotoPickerVc) {
        ...
        photoPickerVc.singleChoose = _singleImg;
