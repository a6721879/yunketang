...
- (id)initWithFrame:(CGRect)frame userList:(NSString *)userListController{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        //标题控件
        self.titleText = MTLocalized(@"Title.UserList");
...
-(void)loadTableView:(CGRect)frame{
    ...
    //用户列表头部
    _userHeaderView =[[[NSBundle mainBundle] loadNibNamed:@"TKCTUserListHeaderView" owner:nil options:nil] lastObject];
    ...
    [_iFileTableView registerNib:[UINib nibWithNibName:@"TKCTUserListTableViewCell" bundle:nil] forCellReuseIdentifier:@"TKCTUserListTableViewCell"];
    [self addSubview:_iFileTableView];
    
    
    // 底部视图
    _userFooterView = [[[NSBundle mainBundle] loadNibNamed:@"TKCTUserListFooterView" owner:nil options:nil] lastObject];
