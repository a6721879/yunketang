...
//    标准版用的是__none 从逻辑上讲 感觉应该用__all，暂时未发现问题
    [[TKRoomManager instance] pubMsg:@"AnswerCommit" msgID:msgID toID:@"__none" data:json save:NO extensionData:dict completion:^(NSError *error) {
...
- (UIButton *)submitButton
{
    if (!_submitButton) {
        ...
        [_submitButton setTitle:MTLocalized(@"tool.submit") forState:UIControlStateNormal];
        [_submitButton setTitle:MTLocalized(@"tool.modify") forState:UIControlStateSelected];
