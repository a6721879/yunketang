...
- (void)addTeacherView {
    ...
    instView.backgroundColor = [UIColor redColor];
...
- (void)MyselfDecision_TeacherInfo:(NSString *)textStr {
    ...
    _mainScroll.contentSize = CGSizeMake(MainScreenWidth, _scrollHight > _tabelHeight ? _scrollHight : _tabelHeight + 10);
}
    ...
    if (button.tag == 1) {//课程详情
        if (isUnwindClass) {//收上来
            ...
            if (isUnwindTeacher) {
                ...
                if (isHaveTeacherImage) {
                    _introduceView.frame = CGRectMake(10 * WideEachUnit, CGRectGetMaxY(_teacherImage.frame) + 10 * WideEachUnit, MainScreenWidth - 20 * WideEachUnit, 20 * WideEachUnit + _teacherInfoViewHight + _teacherWebHight);
                }
                _instLineButton.frame = CGRectMake(0, CGRectGetMaxY(_introduceView.frame) + 10 * WideEachUnit, MainScreenWidth, 10 * WideEachUnit);
                _instView.frame = CGRectMake(0, CGRectGetMaxY(_introduceView.frame) + 20 * WideEachUnit, MainScreenWidth, 100 * WideEachUnit);
            ...
            if (isHaveImage) {
                _classIntroView.frame = CGRectMake(0, 0 * WideEachUnit, MainScreenWidth, 20 * WideEachUnit + _classIntroViewHight + _webHight);
            ...
            if (isUnwindTeacher) {
                _teacherInfo.frame = CGRectMake(10 * WideEachUnit,10 * WideEachUnit ,MainScreenWidth - 40 * WideEachUnit,_teacherInfoViewHight);
                _introduceView.frame = CGRectMake(10 * WideEachUnit, CGRectGetMaxY(_teacherWebView.frame) + 10 * WideEachUnit, MainScreenWidth - 20 * WideEachUnit, 20 * WideEachUnit + _teacherInfoViewHight );
                _instLineButton.frame = CGRectMake(0, CGRectGetMaxY(_introduceView.frame) + 10 * WideEachUnit, MainScreenWidth, 10 * WideEachUnit);
                _instView.frame = CGRectMake(0, CGRectGetMaxY(_introduceView.frame) + 20 * WideEachUnit, MainScreenWidth, 100 * WideEachUnit);
                _teacherView.frame = CGRectMake(0, CGRectGetMaxY(_classIntroView.frame) + 10 * WideEachUnit, MainScreenWidth, 180 * WideEachUnit + _teacherInfoViewHight + 65 * WideEachUnit);
            } else {
        ...
        if (isUnwindTeacher) {//收上来
            ...
            if (isHaveTeacherImage) {
                _teacherView.frame = CGRectMake(0, CGRectGetMaxY(_classIntroView.frame) + 10 * WideEachUnit, MainScreenWidth, 180 * WideEachUnit + _teacherWebHight + 65 * WideEachUnit + _teacherInfoViewHight);
                _introduceView.frame = CGRectMake(10 * WideEachUnit, CGRectGetMaxY(_teacherImage.frame) + 10 * WideEachUnit, MainScreenWidth - 20 * WideEachUnit, 0 * WideEachUnit + _teacherWebHight + _teacherInfoViewHight );
