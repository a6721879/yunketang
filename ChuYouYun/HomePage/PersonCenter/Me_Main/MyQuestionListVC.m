...
@interface MyQuestionListVC ()<UITableViewDelegate, UITableViewDataSource> {
    NSInteger page;
}
...
@implementation MyQuestionListVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MyQuestionListCell *cell = [tableView dequeueReusableCellWithIdentifier:reuse];
    if (!cell) {
        cell = [[MyQuestionListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuse];
    }
    [cell setQuestionListCellInfo:_dataSource[indexPath.row] typeString:_typeString];
    return cell;
}
