...
- (void)addTableView {
    ...
    _tableView = [[STTableView alloc] initWithFrame:CGRectMake(0, 64, MainScreenWidth, MainScreenHeight - 24) style:UITableViewStyleGrouped];
    if (iPhoneX) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    vc.ID = [NSString stringWithFormat:@"%@",[[_dataArray objectAtIndex:indexPath.row - 1] stringValueForKey:@"new_uid"]];
