//
//  Good_QuesAndAnsNewViewController.m
//  YunKeTang
//
...
@interface Good_QuesAndAnsNewViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation Good_QuesAndAnsNewViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cellStr = [NSString stringWithFormat:@"New-%ld",indexPath.row];
